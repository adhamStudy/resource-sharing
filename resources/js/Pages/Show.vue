            ...
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    ...
                    >
                        ...
                        <button
                            class="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 mr-2"
